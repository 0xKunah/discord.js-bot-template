...
module.exports = new Command("kick", (msg, args) => {
    if(msg.member.permissions.has(Permissions.FLAGS.KICK_MEMBERS)){
        ...
        } else msg.channel.send({embeds : [new Error_Embed(msg.author, "I can't kick members")]})
    } else msg.channel.send({embeds : [new Error_Embed(msg.author, "You can't kick members")]})
})