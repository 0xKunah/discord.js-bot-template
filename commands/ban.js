...
module.exports = new Command("ban", (msg, args) => {
    if(msg.member.permissions.has(Permissions.FLAGS.BAN_MEMBERS)){
        ...
        } else msg.channel.send({embeds : [new Error_Embed(msg.author, "I can't ban members")]})
    } else msg.channel.send({embeds : [new Error_Embed(msg.author, "You can't ban members")]})
})